...
function parseObject(obj: Record<string, any>, property: string, keyParts: string[], value: FormDataEntryValue) {
...
function parseArray(arr: any[], i: number, keyParts: string[], value: FormDataEntryValue) {
    if (keyParts.length === 0) {
        arr[i] = value
        return
    }
