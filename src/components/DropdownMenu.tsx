...
export default function DropdownMenu({
  ...
  return (
    ...
    >
      <button
        className={`focus:outline-hidden hover:underline focus:underline ${buttonClassName}`}
        type="button"
...
const className =
  "focus:outline-hidden focus:bg-gray-200 hover:bg-gray-200 block whitespace-nowrap px-4 py-1 text-start w-full";
...
export function DropdownMenuSubmenu({
  ...
  return (
    <li ref={root} className="relative" onBlur={onBlur}>
      <button
        className="focus:outline-hidden focus:underline hover:underline whitespace-nowrap px-4 py-1 text-start w-full"
        type="button"
        onClick={(e) => {
          e.stopPropagation();
          setIsOpen((menu) => !menu);
