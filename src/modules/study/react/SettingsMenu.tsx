...
export default function SettingsMenu({
  ...
  return (
    <Popover className="relative">
      ...
      <Popover.Panel className="absolute z-50 border border-gray-400 shadow-lg p-4 rounded bg-white -end-1 mt-3 min-w-[200px] flex flex-col gap-4 dark:bg-gray-800 dark:border-gray-700 dark:shadow-none">
